...
const projects = [
  ...
  },
  {
    ...
    link: "https://github.com/Sujoymoulick/MEGHDOOT"
  },
  {
    id: 3,
    title: "Textora",
    ...
    link: "https://github.com/Sujoymoulick/TEXTORA"
  },
  {
    id: 4,
    title: "P2P Ticket",
    ...
    link: "https://github.com/Sujoymoulick/P2P-ticket-resale-platform."
  },
  {
    id: 5,
    title: "Digital Clock",
    ...
    link: "https://github.com/Sujoymoulick/Digital-clock"
  },
];
    ...
    <section id="works" className="relative text-white overflow-hidden w-full py-32">
            ...
            projects.map((project, index) => {
              ...
              return (
                <a
                  ...
                  className="group relative w-[240px] h-[340px] xl:w-[280px] xl:h-[400px] overflow-hidden rounded-2xl bg-[#0a0a0c] border border-white/10 shadow-2xl block"
                >
                    ...
                    {project.cat === "Web3" ? (
                      ...
                      <>
                        <img
                          src={project.img}
                          alt={project.title}
                          className={`h-full w-full object-cover transition-transform duration-700 ease-out ${isActive ? 'scale-110 blur-0' : 'scale-100 blur-[2px] grayscale-[50%]'
                            }`}
                        />
        ...
        <div className="flex flex-col items-center justify-center gap-12 px-6 pb-24 relative z-10 w-full max-w-lg mx-auto">
          {projects.map((project) => (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative w-full aspect-[3/4] max-h-[450px] overflow-hidden rounded-2xl bg-[#0a0a0c] border border-white/10 shadow-2xl block"
            >
              <div className="absolute inset-0 overflow-hidden">
                {project.cat === "Web3" ? (
                  <div className="w-full h-full relative z-0">
      ...
      <div className="flex justify-center mt-20 relative z-20">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-3 px-8 py-4 bg-white/5 hover:bg-white text-white hover:text-black border border-white/10 rounded-full transition-all duration-500 font-bold tracking-widest uppercase text-xs"
        >
