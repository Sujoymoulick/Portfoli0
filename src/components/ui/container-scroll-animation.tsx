...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-[#333] p-2 md:p-4 bg-zinc-900 rounded-[30px] shadow-2xl relative z-20"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-zinc-800 md:rounded-2xl">
        {children}
      </div>
    </motion.div>
  );
