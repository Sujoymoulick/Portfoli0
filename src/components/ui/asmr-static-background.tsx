...
const ASMRStaticBackground: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0c] overflow-hidden pointer-events-none z-[-1]">
      <canvas
        ref={canvasRef}
        className="block w-full h-full"
      />
      
      {/* Optional UI Overlay - Simplified for background use */}
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center pointer-events-none opacity-20">
        <div className="px-8 py-4 border border-white/5 bg-white/[0.02] backdrop-blur-sm rounded-sm">
          <h2 className="text-white font-light tracking-[0.7em] uppercase text-sm md:text-xl">
